...
chart <- ggplot(data = uptake_by_month, aes(x = as.Date(yearmon), y = uptake)) +
  ...
  # Create line to show 60% standard
...
![Line graph showing uptake in the Scottish Bowel Screening Programme, against the 60% standard, over time.](chart1.png) \
